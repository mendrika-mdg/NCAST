...
fss_raw = {w: {"model": [], "persistence": []} for w in windows}
fss_smooth = {w: {"model": [], "persistence": []} for w in windows}
...
print("\nwindow_px | scale_km | raw_model | raw_persistence | smooth_model | smooth_persistence")
...
for w in windows:
    ...
    print(
        ...
        f"{r_mod:>9.4f} | {r_per:>15.4f} | "
        f"{s_mod:>12.4f} | {s_per:>18.4f}"
    )
