...
OUTPUT_BASE = f"/work/scratch-nopw2/mendrika/OB/ncast/evaluation/nowcasts/base/t{LEAD_TIME}"
...
# scaler
COLS_TO_SCALE = range(4, 12) # do not scale temporal features as they are already between 0 and 1
